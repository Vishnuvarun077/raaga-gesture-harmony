...
export const languages: Record<string, LanguageTexts> = {
  en: {
    ...
    instruction1: "• Index finger to thumb: Ma",
    instruction2: "• Middle finger to thumb: Ga",
    instruction3: "• Ring finger to thumb: Ri",
    instruction4: "• Pinky finger to thumb: Sa",
    instruction5: "• Index finger to thumb: Pa",
    instruction6: "• Middle finger to thumb: Da",
    instruction7: "• Ring finger to thumb: Ni",
    instruction8: "• Pinky finger to thumb: Not used for notes",
  ...
  te: {
    ...
    instruction1: "• చూపుడు వేలు - బొటనవేలు: మ",
    instruction2: "• మధ్య వేలు - బొటనవేలు: గ",
    instruction3: "• ఉంగరపు వేలు - బొటనవేలు: రి",
    instruction4: "• చిటికెన వేలు - బొటనవేలు: సా",
    instruction5: "• చూపుడు వేలు - బొటనవేలు: ప",
    instruction6: "• మధ్య వేలు - బొటనవేలు: ద",
    instruction7: "• ఉంగరపు వేలు - బొటనవేలు: ని",
    instruction8: "• చిటికెన వేలు - బొటనవేలు: స్వరాలకు ఉపయోగపడదు",
  ...
  hi: {
    ...
    instruction1: "• तर्जनी से अंगूठे तक: म",
    instruction2: "• मध्यमा से अंगूठे तक: ग",
    instruction3: "• अनामिका से अंगूठे तक: रि",
    instruction4: "• कनिष्ठा से अंगूठे तक: सा",
    instruction5: "• तर्जनी से अंगूठे तक: प",
    instruction6: "• मध्यमा से अंगूठे तक: ध",
    instruction7: "• अनामिका से अंगूठे तक: नि",
    instruction8: "• कनिष्ठा से अंगूठे तक: स्वरों के लिए उपयोग नहीं होता",
